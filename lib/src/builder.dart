...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  MarkdownBuilder({ this.delegate, this.styleSheet, this.imageDirectory, this.networkImageBuilder });
  ...
  Widget _buildImage(String src) {
    ...
    if (uri.scheme == 'http' || uri.scheme == 'https') {
      if (networkImageBuilder != null) {
        child = networkImageBuilder(uri.toString(), width: width, height: height);
      } else {
